...
class ApiaryService:
    ...
    def create_apiary(self, apiary_name: str, user: str) -> Apiary:
        return self._repository.add(name=apiary_name, user=user)

    def update_apiary(self, apiary_id: int, apiary_name, user: str) -> Apiary:
        return self._repository.update(apiary_id=apiary_id, name=apiary_name)

    def delete_apiary_by_id(self, apiary_id: int, user: str) -> None:
        return self._repository.delete_by_id(apiary_id, user)
