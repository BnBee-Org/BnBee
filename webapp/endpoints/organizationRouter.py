...
def add(
    ...
    return organization_service.create_organization(organization_name=organization_name,logged_user_email=logged_user_email)
...
def remove(
    ...
    try:
        organization_service.delete_organization_by_id(organization_id=organization_id,logged_user_email=logged_user_email)
